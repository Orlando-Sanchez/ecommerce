...
ActiveRecord::Schema[8.0].define(version: 2025_11_13_001321) do
  ...
  create_table "user_types_users", id: false, force: :cascade do |t|
    ...
    t.index ["user_id", "user_type_id"], name: "index_user_types_users_on_user_id_and_user_type_id", unique: true
  end
  ...
  add_foreign_key "store_assignments", "stores"
  add_foreign_key "store_assignments", "users"
